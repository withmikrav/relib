include TypedArray.Impl({
  ...
  @ocaml.doc(
    "The `BigUint64Array` typed array represents an array of 64-bit unsigned integers in the platform byte order. If control over byte order is needed, use `DataView` instead."
  )
...
@new
external make: unit => t = "BigUint64Array"

@new
external makeWithLength: int => t = "BigUint64Array"

@new
external fromArrayBuffer: (ArrayBuffer.t, ~offset: int, ~length: int) => t = "BigUint64Array"

// Static properties

@ocaml.doc("Returns a number value of the element size. `8` in the case of an `BigUint64Array`.")
@scope("BigUint64Array")
@val
