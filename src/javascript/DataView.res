...
module Impl = (
  ...
  @send
  external getFloat32WithLittleEndian: (t, ~offset: int, ~littleEndian: bool) => float =
    "getFloat32"
  ...
  @send
  external getFloat64WithLittleEndian: (t, ~offset: int, ~littleEndian: bool) => float =
    "getFloat64"
  ...
  @send
  external setBigInt64WithLittleEndian: (
    t,
    ~offset: int,
    ~value: int,
    ~littleEndian: bool,
  ...
  @send
  external setBigUint64WithLittleEndian: (
    t,
    ~offset: int,
    ~value: int,
    ~littleEndian: bool,
...
module ArrayBuffer = Impl({
  type bufferT = ArrayBuffer.t
})

module SharedArrayBuffer = Impl({
  type bufferT = SharedArrayBuffer.t
})
